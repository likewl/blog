...
(function(mod) {
  ...
  // Very basic readline/emacs-style1 bindings, which are standard on Mac.
  keyMap.emacsy = {
  ...
  // Compute a style1 array (an array starting with a mode generation
  // -- for invalidation -- followed by pairs of end positions and
  // style1 strings), which is used to highlight the tokens on the
  // line.
  function highlightLine(cm, line, state, forceToEnd) {
    ...
    // Run overlays, adjust style1 array.
  ...
  // update state, but don't save a style1 array. Used for lines that
  ...
  // Convert a style1 as returned by a mode (either null, or a string
  // containing one or more styles) to a CSS style1. This is cached,
  ...
  // Create a history change event from an updateDoc-style1 change
  // object.
